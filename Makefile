train-sp:
	python3.7 chem_sentencepiece/chem_sentencepiece.py --vocab 4000 --input ./Repository/LargeCorpus/large_corpus.txt
...
train-lm:
	python3.7 languagemodel/train.py --config config/test.config
